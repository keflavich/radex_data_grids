...
mole = 'o-h2co-scaled1.6'  # molecular data name

# Naming suffix to append to line name defined in "acts" below
suffix = "_T5to55_sphere_greenscaled"
...
try:
    ...
    mpirank = MPI.COMM_WORLD.Get_rank()  # processor ID
    mpisize = MPI.COMM_WORLD.Get_size()  # number of processors
    print "Found %i processors, this is #%i" % (mpisize,mpirank)
except ImportError:
