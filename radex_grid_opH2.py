...
import time
import sys
sys.path.append('/duanestorage/home/student/silvia/local/x86_64/lib/python2.6/site-packages/')
#
...
ndens = 201    # number of density points
ncol  = 201    # number of column points
...
suffix = "_T=5to55_lvg_troscompt_100square_orthopara%s" % (str(orthopararatio))
