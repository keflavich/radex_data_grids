...
tmax = 100.0  # maximum kinetic temperature (K)
...
mole = 'p-h2co'  # molecular data name

# Naming suffix to append to line name defined in "acts" below
suffix = "_para_T=10to100_lvg"
# acts = list of lines to ratio.  Filenames must include ".dat" in order for suffix to be applied
acts = [[0.071,0.355,'2-2_3-3.dat']]
flow = 0.07     # lowest frequency transition to include in output file
fupp = 0.5      # highest frequency transition to include in output file
bw    = 0.1     # "bandwidth": free spectral range around line (used to say which lines get printer)
