...
orthopara    = [ opmin + (ii) / float(norpa-1) * (opmax-opmin)  for ii in range(norpa) ]
# LOG orthopara    = [ 10**( math.log10(opmin) + (ii) / float(norpa-1) * (math.log10(opmax)-math.log10(opmin)) )  for ii in range(norpa) ] # LOG
...
suffix = "_T=5to55_lvg_troscompt_100square_linopgrid"
